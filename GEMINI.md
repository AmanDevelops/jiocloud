...
A minimal, rclone-style Go CLI for the JioAiCloud API. It supports authentication, user information retrieval, single-file uploads (with automatic chunking for large files), and one-way directory synchronization (mirroring).
